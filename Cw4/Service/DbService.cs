...
namespace cw5.Service
{
    ...
    {
        String db = "Data Source=db-mssql;Initial Catalog=s16712;Integrated Security=True; MultipleActiveResultSets=True";
        ...
        public IEnumerable<Student> GetStudents()
        {
            ...
            String db = "Data Source=db-mssql;Initial Catalog=s16712;Integrated Security=True";
